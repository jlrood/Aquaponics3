...
export default class Shop extends Phaser.Scene {
	...
	editorCreate() {
		...
		// Back_Button
		const back_Button = this.add.ellipse(50, 50, 128, 128);
		...
		// BackText
		const backText = this.add.text(31, 41, "", {});
		backText.text = "Back";
		...
		// Fish_Box
		const fish_Box = this.add.rectangle(40, 120, 167, 74);
		...
		// Equip_Box
		const equip_Box = this.add.rectangle(571, 120, 167, 74);
		...
		// System_Box
		const system_Box = this.add.rectangle(394, 120, 167, 74);
		...
		// Plant_Box
		const plant_Box = this.add.rectangle(217, 120, 167, 74);
		...
		// rectangle_4
		const rectangle_4 = this.add.rectangle(760, 120, 484, 565);
		...
		// option_box_2
		const option_box_2 = this.add.rectangle(200, 240, 120, 120);
		...
		// option_box_3
		const option_box_3 = this.add.rectangle(340, 240, 120, 120);
		...
		// option_box_4
		const option_box_4 = this.add.rectangle(480, 240, 120, 120);
		...
		// option_box_5
		const option_box_5 = this.add.rectangle(60, 380, 120, 120);
		...
		// option_box_6
		const option_box_6 = this.add.rectangle(200, 380, 120, 120);
		...
		// option_box_7
		const option_box_7 = this.add.rectangle(340, 380, 120, 120);
		...
		// option_box_8
		const option_box_8 = this.add.rectangle(480, 380, 120, 120);
		...
		// option_box_9
		const option_box_9 = this.add.rectangle(60, 520, 120, 120);
		...
		// option_box_10
		const option_box_10 = this.add.rectangle(200, 520, 120, 120);
		...
		// option_box_11
		const option_box_11 = this.add.rectangle(340, 520, 120, 120);
		...
		// option_box_12
		const option_box_12 = this.add.rectangle(480, 520, 120, 120);
