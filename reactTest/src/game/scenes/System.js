...
export default class System extends Phaser.Scene {
	...
	editorCreate() {
		...
		// back_button
		const back_button = this.add.ellipse(170, 130, 128, 128);
		...
		// back_text
		const back_text = this.add.text(151, 120, "", {});
		back_text.text = "Back";
		back_text.setStyle({ "color": "#000000ff" });

		// stat_box
		const stat_box = this.add.rectangle(150, 190, 500, 150);
		...
		// system_graph_box
		const system_graph_box = this.add.rectangle(150, 363, 500, 190);
		...
		// week_button
		const week_button = this.add.rectangle(674, 190, 145, 60);
		...
		// month_button
		const month_button = this.add.rectangle(829, 190, 145, 60);
		...
		// year_button
		const year_button = this.add.rectangle(984, 190, 145, 60);
		...
		const production_graph_box = this.add.rectangle(674, 273, 455, 280);
		...
		// divider
		const divider = this.add.rectangle(400, 265, 5, 128);
		divider.isFilled = true;
		divider.fillColor = 0;

		// system_header
		const system_header = this.add.text(400, 573, "", {});
		system_header.setOrigin(0.5, 0);
		system_header.text = "System";
		system_header.setStyle({ "color": "#000000ff", "fontSize": "32px" });

		// production_header
		const production_header = this.add.text(901, 573, "", {});
